...
if ((!isset($_GET['gkey'])) || ($_GET['gkey'] != $parameters['gkey'])) 	{
		...
		foreach ($query->rows as $product) {
			echo 'Ürün Alt Etiketi oluşturuluyor; <b>'.$product['pname'].' (kategori; '.$product['cname'].')</b>: ';
			...
			echo " - ".( (!$parameters['calts']) ?" 0 ":"<span style=\"color:red;\">$calts</span> ")." Ürün Alt Etiketi oluşturuldu;<br>";
			}
	}
