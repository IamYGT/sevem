...
class ControllerExtensionExtensionClickFix extends Controller {
	...
	public function index() {
		...
		$data['aboutseourls'] .= $q.'/'.$queryt->row['total'].' Ürün SEO URL  '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').'</br>';
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutseourls'] .= $q.'/'.$queryt->row['total'].' Kategori SEO URL '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').' </br>';
		if ($query->row['total'] < $queryt->row['total']) $data['fixseourls'] = true;
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutseourls'] .= $q.'/'.$queryt->row['total'].' Marka SEO URL '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').' </br>';
		if ($query->row['total'] < $queryt->row['total']) $data['fixseourls'] = true;
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutseourls'] .= $q.'/'.$queryt->row['total'].' Bilgi Sayfası SEO URL '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').' </br>';
		if ($query->row['total'] < $queryt->row['total']) $data['fixseourls'] = true;
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutmetadescription'] .= $q.'/'.$queryt->row['total'].' ürün meta açıklaması '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').'</br>';
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutmetadescription'] .= $q.'/'.$queryt->row['total'].' kategori meta açıklaması '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').'</br>';
		if ($query->row['total'] < $queryt->row['total']) $data['fixmetadescription'] = true;
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutmetadescription'] .= $q.'/'.$queryt->row['total'].' bilgi sayfası meta açıklaması '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').'</br>';
		if ($query->row['total'] < $queryt->row['total']) $data['fixmetadescription'] = true;
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutmetakeyword'] .= $q.'/'.$queryt->row['total'].' ürün meta kelimeleri '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').'</br>';
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutmetakeyword'] .= $q.'/'.$queryt->row['total'].' kategori meta kelimeleri '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').'</br>';
		if ($query->row['total'] < $queryt->row['total']) $data['fixmetakeyword'] = true;
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutmetakeyword'] .= $q.'/'.$queryt->row['total'].' bilgi sayfaları meta kelimeleri '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').'</br>';
		if ($query->row['total'] < $queryt->row['total']) $data['fixmetakeyword'] = true;
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutmetatitle'] .= $q.'/'.$queryt->row['total'].' ürün meta başlığı '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').'</br>';
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutmetatitle'] .= $q.'/'.$queryt->row['total'].' kategori meta başlığı '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').'</br>';
		if ($query->row['total'] < $queryt->row['total']) $data['fixmetatitle'] = true;
		...
		$q = (($query->row['total'] >= $queryt->row['total'])? $queryt->row['total'] : $query->row['total']);
		$meter[] .= ($queryt->row['total']>0)?($q/$queryt->row['total']):1;
		$data['aboutmetatitle'] .= $q.'/'.$queryt->row['total'].' bilgi sayfaları meta başlığı '.(($query->row['total'] >= $queryt->row['total'])? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').'</br>';
		if ($query->row['total'] < $queryt->row['total']) $data['fixmetatitle'] = true;
		...
		$meter[] .= $q/$tmlseo;
		$data['aboutmlseo'] .= $q.'/'.$tmlseo.' Çoklu dil seo aktif (sadece tr aktif ise kullanmayın) '.(($q >= $tmlseo)? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').' </br>';
		...
		$meter[] .= $q/$tcanonicals;
		$data['aboutcanonicals'] .= $q.'/'.$tcanonicals.' Canonical Link aktif '.(($q >= $tcanonicals)? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').' </br>';
		...
		$data['aboutrichsnippets'] .= $q.'/'.$trichsnippets.' Rich Snippets Sosyal Medya SEO Aktif '.(($q >= $trichsnippets)? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').' </br>';
		...
		$data['aboutseopagination'] .= $q.'/'.$tseopagination.' Seo sayfalama aktif '.(($q >= $tseopagination)? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').' </br>';
		...
		$data['aboutextendedseo'] .= $q.'/'.$textendedseo.' Canonical Link aktif '.(($q >= $textendedseo)? '<b style="color:green">- Tamamlandı</b>':'<b style="color:red">- Düzelme gerekli</b>').' </br>';
