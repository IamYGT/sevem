...
if ((!isset($_GET['gkey'])) || ($_GET['gkey'] != $parameters['gkey'])) 	{
		...
		foreach ($query->rows as $product) {
			echo 'Meta Açıklama oluşturuluyor <b>'.$product['pname'].' (kategori; '.$product['cname'].')</b>: ';
			...
			echo " - ".( (!$count) ?"0 ":"<span style=\"color:red;\">$meta_description</span> ")."Meta Açıklama oluşturuldu.<br>";
			}
	}
