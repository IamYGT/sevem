...
<body>
<FORM><INPUT TYPE="BUTTON" VALUE="Geri Dön"
...
if ((!isset($_GET['gkey'])) || ($_GET['gkey'] != $parameters['gkey'])) 	{
		...
		foreach ($query->rows as $product) {
			echo 'Resim Title Etiketi oluşturuluyor <b>'.$product['pname'].' (kategori; '.$product['cname'].')</b>: ';
			...
			echo " - ".( (!$parameters['cimgtitles']) ?" 0 ":"<span style=\"color:red;\">$cimgtitles</span> ")." Resim Title Etiketi oluşturuldu.<br>";
			}
	}
