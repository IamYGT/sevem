...
if ((!isset($_GET['gkey'])) || ($_GET['gkey'] != $parameters['gkey'])) 	{
		...
		foreach ($query->rows as $product) {
			$newp = 0; $newtags ='';
			echo 'Ürün Etiket Oluşturuluyor <b>'.$product['pname'].' (kategori; '.$product['cname'].')</b>: ';
			...
			echo " - $newp Ürün Etiket Oluşturululdu.<br>";
			}

		echo "<br>Toplam $new Ürün Etiket Oluşturululdu.";
		$db->query("update " . DB_PREFIX . "product_description set tag = lower( tag );");
	}
?>
