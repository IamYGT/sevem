...
if ((!isset($_GET['gkey'])) || ($_GET['gkey'] != $parameters['gkey'])) 	{
		...
		foreach ($query->rows as $product) {
			echo 'Ürün Başlık Etiketi oluşturuluyor <b>'.$product['pname'].' (kategori; '.$product['cname'].')</b>: ';
			...
			echo " - ".( (!$parameters['ctitles']) ?" 0 ":"<span style=\"color:red;\">$ctitles</span> ")." Ürün Başlık Etiketi oluşturuldu.<br>";
			}
	}
